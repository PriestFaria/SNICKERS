  ...
  <div class="h-96 relative flex justify-center items-center">
    <div class="absolute top-1/4 ">
      <div class="flex flex-col items-center">
        <img src="../../public/emoji-1.png" alt="sad_emoji" srcset="" class="w-16 -translate-x-1">
        <b class=" mt-5  ">Закладок нет :(</b>
        <span class="text-slate-400  ">Вы ничего не добавляли в закладки</span>
